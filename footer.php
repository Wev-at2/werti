			...
			<div class="footer__logo">
				<a class="footer__logo--link" href="/">
					<figure class="footer__logo--img img">
						<svg>
							<use xlink:href="
								<?php echo get_stylesheet_directory_uri(); ?>/img/sprites/sprite.svg#anac_logo_v1_white" alt="Logo da ANAC" title="ANAC - Associação Nacional de Assitência ao Cardíaco">
							</use>
						</svg>
